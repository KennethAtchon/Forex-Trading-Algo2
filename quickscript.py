...
# IMPORTANT: THE PURPOSE OF THIS SCRIPT IS TO MAKE SMALL BETS 
# IN EVERY MARKET IN ORDER FOR THE BOT TO NOT CREATE AN ERROR 
# IF YOU SEND AN ORDER USING THE OTHER SCRIPTS
...
while(x < len(instruments)):
    ...
    movingaverage = simplemovingaverage(length, candleMA)
    ...
    if recentcandleprice >= movingaverage:
        ...
        buyorder = oanda.placeBuyOrder(instrument, 500, -1,-1)
        ...
        sellorder = oanda.placeSellOrder(instrument, 500, -1, -1)
