...
while(True):
    ...
    if not positions['positions'] or positions['positions'][0]['instrument'] != instrument:
        ...
        if signal == "Buy":
            ...
            takeprofit = buyprice + takeprofitpips[0]
            stoploss = buyprice - stoplosspips[0]

            takeprofit = round(takeprofit, roundnum[0])
            stoploss = round(stoploss, roundnum[0])
            ...
            takeprofit = sellprice - takeprofitpips[0]
            stoploss = sellprice + stoplosspips[0]
